...
/****** Object:  Database [Twitter_db]    Script Date: 5/6/2016 11:03:48 AM ******/
CREATE DATABASE [Twitter_db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Twitter_db', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\Twitter_db.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Twitter_db_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\Twitter_db_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
ALTER DATABASE [Twitter_db] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [Twitter_db] SET  DISABLE_BROKER 
GO
