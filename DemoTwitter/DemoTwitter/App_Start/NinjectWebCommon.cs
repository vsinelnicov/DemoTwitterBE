...
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(DemoTwitter.App_Start.NinjectWebCommon), "Stop")]

namespace DemoTwitter.App_Start
{
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<ITweetMapper>().To<TweetMapper>();
            kernel.Bind<ITwitter_dbEntities>().To<Twitter_dbEntities>();
